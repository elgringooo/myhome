...
/**
 * http://www.databaseprimer.com/pages/relationship_1to1/ http://blog.paumard.org/cours/jpa/chap03-entite-relation.html
 * @author Thales
 */
public class CustomerSample {

    private static final Logger logger = LoggerFactory.getLogger(CustomerSample.class);
