...
public class CompanyManagerController {
    ...
    public String display(ModelMap pModel, HttpSession session) {
        ...
        System.out.println(String.format("session = %s ===>", session.getAttribute("asimplecompagny")));
    ...
    public String redirectToCreate(@ModelAttribute("companyForm") CompanyForm companyForm, ModelMap pModel) {
        return "company/edit";
    }

    @RequestMapping(value = "/redirectToUpdateCompany", method = RequestMethod.GET)
    public String
        redirectToUpdate(ModelMap pModel, @ModelAttribute("companyForm") CompanyForm form, @RequestParam(value = "idCompany") final Integer idCompany) {
        System.out.println("test DCMVM !!!!!!!!!");
    ...
    public String save(@Valid @ModelAttribute(value = "companyForm") final CompanyForm formBean, final BindingResult pBindingResult, final ModelMap pModel) {
    ...
    public String delete(@RequestParam(value = "idCompany") final Integer idCompany, final ModelMap pModel) {
