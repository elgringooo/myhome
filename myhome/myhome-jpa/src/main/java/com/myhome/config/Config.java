...
@ComponentScan(basePackages = { "com.myhome" })
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = { "com.myhome.repository" })
@Configuration
public class Config {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:hsqldb:file:C:/hsqldb/data/myHome");
	...
	public EntityManagerFactory entityManagerFactory(
		...
		factory.setPackagesToScan("com.myhome.domain");
