...
public class Profiler {
    ...
    public static void addInstrumentation(CtClass ctClass, CtMethod ctMethod) throws CannotCompileException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CtClass ctClass = pool.get("com.myhome.bytecodeinjection.MyClassInjected");
        ...
        MyClassInjected test = (MyClassInjected) c.newInstance();
