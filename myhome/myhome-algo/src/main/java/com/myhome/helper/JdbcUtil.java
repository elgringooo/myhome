...
public class JdbcUtil {
     ...
     * @throws SQLException
     */
    private synchronized Map<String, String> getColumns(Connection connection, DatabaseMetaData metaData, String schema, String tableName) throws SQLException {
     ...
     * @throws SQLException
     */
    public synchronized Map<String, Map<String, String>> getTables(Connection connection, String schema, String filter) throws SQLException {
     ...
     * @throws SQLException
     */
    public synchronized String execute(Connection connection, String procedureName, String[] params) throws SQLException {
        ...
        try {
            ...
            sqlQuery.append(")}");
            statement = connection.prepareCall(sqlQuery.toString(), ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY);
            if (params != null) {
                for (int i = 0; i < params.length; i++) {
