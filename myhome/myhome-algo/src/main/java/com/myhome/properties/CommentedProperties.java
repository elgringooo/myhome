...
/**
 * to allow retention of comment lines and blank (whitespace only) lines in the properties file. Written for Java version 1.4
 */
public class CommentedProperties extends java.util.Properties {
    ...
    public void store(OutputStream out, String header) throws IOException {
        ...
        for (Object o : keys) {
            String k = (String) o;
            if (!keyData.contains(k)) {
                // Put to the end of file new property
                add((String) k, this.getProperty(k));
            }
        }
    ...
    /**
     * Need this method from Properties because original code has StringBuilder, which is an element of Java 1.5, used StringBuffer instead (because this code
     * was written for Java 1.4)
    ...
    public synchronized Object remove(Object key) {
        int index = -1;
        while ((index = keyData.indexOf(key)) > -1) {
            lineData.remove(index);
            keyData.remove(index);
        }
